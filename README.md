![docker image](https://github.com/CAU-Kiel/nomad-oasis-image/actions/workflows/docker-publish.yml/badge.svg)


# CAU-Kiel's NOMAD Oasis Distribution

This is the NOMAD Oasis distribution of CAU-Kiel.
...
2. Clone the repository or download the repository as a zip file.
    ...
    ```sh
    git clone https://github.com/CAU-Kiel/nomad-oasis-image.git
    ...
    ```sh
    curl-L -o nomad-oasis-image.zip "https://github.com/CAU-Kiel/nomad-oasis-image/archive/main.zip"
...
your `docker-compose.yaml` with `ghcr.io/cau-kiel/nomad-oasis-image:main` for the services
...
```sh
docker pull ghcr.io/cau-kiel/nomad-oasis-image/jupyter:main
```
...
By default, documentation is built using the [nomad-docs](https://github.com/CAU-Kiel/nomad-docs) repository. However, if you'd like to customize the documentation for your Oasis instance, you can easily do so.

1. First, [fork the nomad-docs repository](https://github.com/CAU-Kiel/nomad-docs/fork).
...
_I get an_ `Error response from daemon: Head "https://ghcr.io/v2/CAU-Kiel/nomad-oasis-image/manifests/main": unauthorized`
