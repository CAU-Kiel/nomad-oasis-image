...
```sh
curl -L -o nomad-oasis.zip "https://github.com/CAU-Kiel/nomad-oasis-image/raw/main/nomad-oasis.zip"
```
 ...
 *I get an* `Error response from daemon: Head "https://ghcr.io/v2/CAU-Kiel/nomad-oasis-image/manifests/main": unauthorized`
